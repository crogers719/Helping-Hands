<!DOCTYPE html>
<?php include "auction_remain_times_form.php"; ?>
<html lang="en">
    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="page-header">
          <h1 id="forms">Auction Items Still Remaining within Auction Time </h1>
        </div>
      </div>
    </div>
  <div class="row">
        ...
        <div class="well bs-component">
          <form action="" method="post" class="form-horizontal">
            <fieldset>
                ...
                <div class="col-lg-10 col-lg-offset-2">
                  <button type="submit" class="btn btn-primary" name="report">Report All Remaining Active Items</button>
                </div>
              </div>
            </fieldset>
          </form>
          ...
          <?php 
            ...
            if(!empty($r)){
                ...
                echo '<div class="panel-heading">Active Auctions</div>';
               ...
               while($row=mysql_fetch_array($r)){
                 ...
                 echo '<tr class="info">';
                  ...
                  echo '<td><a href="place_bid.php?id='. $row['AUCTION_ID'] .'">Place Bid</a></td>';
                  echo '</tr>';
                }
                echo '</tbody>';
                echo '</table>';
