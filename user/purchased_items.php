<!DOCTYPE html>
<?php include "purchased_items_form.php"; ?>
<html lang="en">
    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="page-header">
          <h1 id="forms">All Items You Purchased!!! </h1>
        </div>
...
;            
               ...
               while($row=mysql_fetch_array($r)){
                ...
                echo '<td><img src="data:image/jpeg;base64,' . base64_encode( $row['IMAGE'] ) . '" />';                  echo '</tr>';
                    }
                }
