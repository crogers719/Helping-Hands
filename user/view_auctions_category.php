<!DOCTYPE html>
<?php include "view_auctions_category_form.php"; ?>
<html lang="en">
    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="page-header">
          <h1 id="forms">View Active Auction Items by Category</h1>
        </div>
      </div>
    </div>
              ...
              <form action="" method="post" class="form-horizontal">
                ...
                <div class="form-group">
                  <div class="col-lg-10 col-lg-offset-2">
                    <button type="submit" class="btn btn-primary" name="active_items_button">View All Items</button>
                  </div>
                </div>
                </fieldset>
              </form>
